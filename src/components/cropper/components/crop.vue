...
<script>
    ...
    const Crop = {
        ...
        methods: {
            ...
            rotateImage(degress) {
                canvasHelper.rotate(this.originSrc, degress, (data, w, h) => {
            ...
            setLayout(w, h) {
                ...
                this.setStyle(width, height, marginLeft, marginTop, R, true);
            },

            setStyle(w, h, ml, mt, r, isInit) {
            ...
            setCropBox(w, h) {
                ...
                const $selectCropBox = this.find('.crop-box');
                // let $wrap = this.$el;
                const imageWidth = w;
                const imageHeight = h;
                const ratioW = this.ratioW;
                const ratioH = this.ratioH;
                ...
                $selectCropBox.style.cssText = setCssText(CSSObj);
                if (CSSObj.height > imageHeight) {
                    CSSObj.height = (imageHeight / 100) * CROPBOX_PERCENT;
            ...
            resize(e) {
                ...
                const $container = this.find('.g-crop-image-principal');
            ...
            drag(e) {
                e.preventDefault();
                const $el = this.find('.image-wrap');
                this.el = $el;
                const $cropBox = this.find('.crop-box');
